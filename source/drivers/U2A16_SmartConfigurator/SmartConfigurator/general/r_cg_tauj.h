...
***********************************************************************************************************************/
/*
    TAUJ3TTINm Input Signal Selection Register (SELB_TAUJ3I)
*/
/* Select of TAUJ3TTIN3 input signal (SELB_TAUJ3I1,SELB_TAUJ3I3) */
#define _TAUJ3_CHANNEL3_INPUT_TAUJ3I3                   (0x00U) /* Port TAUJ3I3 */
#define _TAUJ3_CHANNEL3_INPUT_RTCA0OUT                  (0x02U) /* Timer Input-RTCA0OUT */
#define _TAUJ3_CHANNEL3_INPUT_TAUJ0OUT0                 (0x0AU) /* Timer Input-TAUJ0TTOUT0 */
#define _TAUJ3_CHANNEL3_INPUT_CLEAR                     (0xF5U) /* Channel3 input clear */
/* Select of TAUJ3TTIN2 input signal (SELB_TAUJ3I0,SELB_TAUJ3I2) */
#define _TAUJ3_CHANNEL2_INPUT_TAUJ3I2                   (0x00U) /* Port TAUJ3I2 */
#define _TAUJ3_CHANNEL2_INPUT_RTCA0OUT                  (0x01U) /* Timer Input-RTCA0OUT */
#define _TAUJ3_CHANNEL2_INPUT_TAUJ0OUT0                 (0x05U) /* Timer Input-TAUJ0TTOUT0 */
#define _TAUJ3_CHANNEL2_INPUT_CLEAR                     (0xFAU) /* Channel2 input clear */

/*
    TAUJ2TTINm Input Signal Selection Register (SELB_TAUJ2I)
*/
/* Select of TAUJ2TTIN3 input signal (SELB_TAUJ2I1) */
#define _TAUJ2_CHANNEL3_INPUT_TAUJ2I3                   (0xFDU) /* Port TAUJ2I3 */
#define _TAUJ2_CHANNEL3_INPUT_TAUJ1OUT0                 (0x02U) /* TAUJ1TTOUT0 */
/* Select of TAUJ2TTIN2 input signal (SELB_TAUJ2I0) */
#define _TAUJ2_CHANNEL2_INPUT_TAUJ2I2                   (0xFEU) /* Port TAUJ2I2 */
#define _TAUJ2_CHANNEL2_INPUT_TAUJ1OUT0                 (0x01U) /* TAUJ1TTOUT0 */
