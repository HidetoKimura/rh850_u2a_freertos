...
/***********************************************************************************************************************
* File Name        : r_cg_intvector_PE1.c
* Version          : 1.0.140
...
#if defined (__CCRH__)
#pragma section const "EIINTTBL_PE1"
#elif defined (__ghs__)
#pragma ghs startdata
#pragma ghs section rodata="EIINTTBL_PE1"
#elif defined (__ICCRH850__)
#pragma location ="EIINTTBL_PE1"
#else
#error Unknown Compiler
#endif
#if defined (__CCRH__)
void * const INT_Vectors_PE1[] = {
#elif defined (__ghs__)
void * const INT_Vectors_PE1[] = {
#elif defined (__ICCRH850__)
__root void * const INT_Vectors_PE1[] = {
#else
#error Unknown Compiler
#endif
    /* IPIR CH0 interrupt; */
