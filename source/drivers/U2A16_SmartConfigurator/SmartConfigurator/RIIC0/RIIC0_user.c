...
extern volatile uint8_t          g_riic0_busy; 
/* End user code. Do not edit comment generated here */

/***********************************************************************************************************************
* Function Name: R_RIIC0_Create_UserInit
* Description  : This function adds user code after initializing the RIIC0.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
...
* Return Value : None
***********************************************************************************************************************/
void r_RIIC0_callback_transmitend(void)
{
    /* Start user code for r_RIIC0_callback_transmitend. Do not edit comment generated here */
    g_riic0_busy=0;
    /* End user code. Do not edit comment generated here */
}
...
* Return Value : None
***********************************************************************************************************************/
void r_RIIC0_callback_receiveend(void)
{
    /* Start user code for r_RIIC0_callback_receiveend. Do not edit comment generated here */
...
* Return Value : None
***********************************************************************************************************************/
void r_RIIC0_callback_receiveerror(MD_STATUS status)
{
    /* Start user code for r_RIIC0_callback_receiveerror. Do not edit comment generated here */
...
***********************************************************************************************************************/
#if defined (__CCRH__)
#pragma interrupt r_RIIC0_error_interrupt(enable=false, channel=685, fpu=true, callt=false)
...
void r_RIIC0_error_interrupt(void)
{
    ...
    else if ((RIIC0.IER.UINT32 & _RIIC_NACK_RECEPTION_INT_ENABLE) && (RIIC0.SR2.UINT32 & _RIIC_NACK_DETECTED)) 
    {
        ...
        else if (_RIIC_MASTER_RECEIVE == g_riic0_mode_flag)
        {
            RIIC0.SR2.UINT32 &= (uint32_t) ~_RIIC_STOP_CONDITION_DETECTED;
            RIIC0.CR2.UINT32 |= _RIIC_STOP_CONDITION_REQUEST;
            /* Dummy read the RIICnDRR register */
...
***********************************************************************************************************************/
#if defined (__CCRH__)
#pragma interrupt r_RIIC0_transmit_interrupt(enable=false, channel=687, fpu=true, callt=false)
#elif defined (__ghs__)
#pragma ghs interrupt
#elif defined (__ICCRH850__)
#pragma type_attribute=__interrupt
...
***********************************************************************************************************************/
#if defined (__CCRH__)
#pragma interrupt r_RIIC0_transmitend_interrupt(enable=false, channel=688, fpu=true, callt=false)
#elif defined (__ghs__)
#pragma ghs interrupt
#elif defined (__ICCRH850__)
#pragma type_attribute=__interrupt
...
***********************************************************************************************************************/
#if defined (__CCRH__)
#pragma interrupt r_RIIC0_receive_interrupt(enable=false, channel=686, fpu=true, callt=false)
#elif defined (__ghs__)
#pragma ghs interrupt
#elif defined (__ICCRH850__)
#pragma type_attribute=__interrupt
