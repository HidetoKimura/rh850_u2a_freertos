...
extern void r_ADCJ1_error_interrupt(void);
...
extern void r_ADCJ1_scan_group4_end_interrupt(void);
...
extern void r_mspi3_interrupt_send(void);
/* MSPI3 Channel selectable Receive status interrupt; */
extern void r_mspi3_interrupt_receive(void);
/* MSPI3 Channel selectable Frame count end interrupt; */
extern void r_mspi3_interrupt_frameend(void);
/* MSPI3 Channel selectable Error interrupt; */
extern void r_mspi3_interrupt_error(void);
...
extern void r_RLIN39_interrupt_send(void);
/* RLIN39 receive completion interrupt; */
extern void r_RLIN39_interrupt_receive(void);
/* RLIN39 status interrupt; */
extern void r_RLIN39_interrupt_error(void);
/* RLIN310 interrupt; */
...
extern void r_INTC_intp4_interrupt(void);
/* External interrupt 5; */
extern void r_INTC_intp5_interrupt(void);
...
extern void r_INTC_intp21_interrupt(void);
...
void * const INT_Vectors_PE0[] = {
#elif defined (__ICCRH850__)
__root void * const INT_Vectors_PE0[] = {
#else
#error Unknown Compiler
#endif
    /* IPIR CH0 interrupt; */
    ...
    (void *)eiint236,
    /* ADCJ1 Scan group 4 (SG4) end interrupt; */
    (void *)r_ADCJ1_scan_group4_end_interrupt,
    /* ADCJ2 A/D error interrupt upper/ lower limit error interrupt; */
    (void *)eiint238,
    /* ADCJ2 Scan group 0 (SG0) end interrupt; */
    (void *)eiint239,
    ...
    (void *)eiint267,
    /* MSPI3 Channel selectable Transmit status interrupt; */
    (void *)r_mspi3_interrupt_send,
    /* MSPI3 Channel selectable Receive status interrupt; */
    (void *)r_mspi3_interrupt_receive,
    /* MSPI3 Channel selectable Frame count end interrupt; */
    (void *)r_mspi3_interrupt_frameend,
    /* MSPI3 Channel selectable Error interrupt; */
    (void *)r_mspi3_interrupt_error,
    /* MSPI4 Channel selectable Transmit status interrupt; */
    (void *)eiint272,
    /* MSPI4 Channel selectable Receive status interrupt; */
    (void *)eiint273,
    ...
    (void *)eiint452,
    /* RLIN39 transmit interrupt; */
    (void *)r_RLIN39_interrupt_send,
    /* RLIN39 receive completion interrupt; */
    (void *)r_RLIN39_interrupt_receive,
    /* RLIN39 status interrupt; */
    (void *)r_RLIN39_interrupt_error,
    /* RLIN310 interrupt; */
    (void *)eiint456,
    /* RLIN310 transmit interrupt; */
    (void *)eiint457,
    ...
    (void *)eiint547,
    /* External interrupt 4; */
    (void *)r_INTC_intp4_interrupt,
    /* External interrupt 5; */
    (void *)r_INTC_intp5_interrupt,
    /* External interrupt 6; */
    (void *)eiint550,
    /* External interrupt 7; */
    (void *)eiint551,
