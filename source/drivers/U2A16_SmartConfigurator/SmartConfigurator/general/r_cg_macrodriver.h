...
void R_Interrupt_Initialize_ForPE0(void);
void R_Interrupt_Initialize_ForPE1(void);
void R_Interrupt_Initialize_ForPE2(void);
void R_Interrupt_Initialize_ForPE3(void);
